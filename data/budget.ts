...
const budget2025: BudgetYear = {
  ...
  items: [
      ...
      children: [
        {
          ...
          children: [
            ...
            { id: "social-pension-other", name: "その他年金関連", amount: 11525 },
          ],
        },
        {
          id: "social-medical",
          ...
          children: [
            ...
            {
              id: "social-medical-kokaho", name: "国民健康保険", amount: 23700,
              children: [
            ...
            { id: "social-medical-other", name: "その他医療費", amount: 13828 },
          ],
        },
        {
          id: "social-care",
          ...
          children: [
            {
              id: "social-care-service", name: "介護給付費", amount: 35200,
              children: [
        ...
        },
        {
          ...
          children: [
            ...
            {
              id: "social-child-hoiku", name: "保育所関連", amount: 11500,
              children: [
            ...
            {
              id: "social-child-kodomo", name: "こども家庭庁関連", amount: 10140,
              children: [
        ...
        },
        {
          ...
          children: [
            ...
            {
              id: "social-welfare-shogai", name: "障害者支援", amount: 7350,
              children: [
        ...
        },
        {
          ...
          children: [
            ...
            {
              id: "social-emp-other", name: "その他雇用対策", amount: 2533,
              children: [
    ...
    },
    {
      ...
      children: [
        {
          id: "bond-interest", name: "利子及割引料", amount: 109830,
          children: [
        ...
        {
          id: "bond-repay", name: "国債償還費", amount: 175915,
          children: [
    ...
    },
    {
      ...
      children: [
        ...
        {
          id: "localalloc-joto", name: "地方譲与税譲与金", amount: 22580,
          children: [
        ...
        { id: "localalloc-tokurei", name: "地方特例交付金等", amount: 6564 },
      ],
    },
    {
      id: "defense",
      ...
      children: [
        {
          id: "defense-jinken", name: "人件費・糧食費", amount: 23600,
          children: [
        ...
        {
          id: "defense-busshi", name: "装備品等購入費", amount: 26800,
          children: [
            ...
            { id: "defense-busshi-other", name: "その他装備品", amount: 2000 },
          ],
        },
        {
        ...
        {
          id: "defense-shisetsu", name: "施設整備費", amount: 4400,
          children: [
    ...
    },
    {
      ...
      children: [
        ...
        { id: "public-other", name: "その他公共事業", amount: 5330 },
      ],
    },
    {
      id: "education",
      ...
      children: [
        ...
        { id: "edu-shisetsu", name: "教育施設費", amount: 3085 },
      ],
    },
    {
      id: "food",
      ...
      children: [
        {
          id: "food-kome", name: "農業経営安定対策", amount: 5800,
          children: [
        ...
        { id: "food-other", name: "その他", amount: 3049 },
      ],
    },
    {
      id: "energy",
      ...
      children: [
        {
          id: "energy-saisei", name: "再生可能エネルギー対策", amount: 3800,
          children: [
        ...
        {
          id: "energy-setsuyaku", name: "省エネルギー対策", amount: 2600,
          children: [
        ...
        { id: "energy-other", name: "その他エネルギー施策", amount: 2838 },
      ],
    },
    {
      id: "sme",
      ...
      children: [
        {
          id: "sme-shien", name: "中小企業支援対策", amount: 980,
          children: [
        ...
        { id: "sme-other", name: "その他", amount: 712 },
      ],
    },
    {
      id: "oda",
    ...
    },
    {
      ...
      children: [
        ...
        { id: "other-gyosei", name: "一般行政費", amount: 32000 },
        { id: "other-justice", name: "司法・警察関係費", amount: 12000 },
        { id: "other-misc", name: "その他", amount: 8950 },
      ],
    },
  ],
};
  ...
  items: [
    {
      ...
      children: [
        ...
        },
        {
          ...
          amount: 41234,
          children: [
            { id: "social-care-service", name: "介護給付費", amount: 34000 },
            { id: "social-care-other", name: "その他介護関連", amount: 7234 },
          ],
        },
        {
          id: "social-child",
        ...
        { id: "social-other", name: "その他", amount: 1848 },
      ],
    },
    {
      id: "bond",
      ...
      amount: 279738,
      children: [
        { id: "bond-interest", name: "利子及割引料", amount: 105714 },
        { id: "bond-repay", name: "国債償還費", amount: 174024 },
      ],
    },
    {
      id: "localalloc",
    ...
    },
    {
      ...
      amount: 79172,
      children: [
        { id: "defense-jinken", name: "人件費・糧食費", amount: 23200 },
        { id: "defense-busshi", name: "装備品等購入費", amount: 23500 },
    ...
    },
    {
      ...
      children: [
        ...
        { id: "public-disaster", name: "災害復旧等", amount: 10500 },
        { id: "public-port", name: "港湾・空港・鉄道整備", amount: 3000 },
        { id: "public-forest", name: "林野公共事業", amount: 3700 },
        { id: "public-fishery", name: "漁港漁場整備", amount: 2100 },
        { id: "public-other", name: "その他公共事業", amount: 6436 },
      ],
    },
    {
      id: "education",
    ...
    },
    {
      ...
      amount: 13049,
      children: [
        { id: "food-kome", name: "農業経営安定対策", amount: 5600 },
        { id: "food-shokuhin", name: "食料品安定供給対策", amount: 4100 },
        { id: "food-other", name: "その他", amount: 3349 },
      ],
    },
    {
      id: "energy",
      ...
      amount: 9238,
      children: [
        { id: "energy-saisei", name: "再生可能エネルギー対策", amount: 3700 },
        { id: "energy-setsuyaku", name: "省エネルギー対策", amount: 2500 },
        { id: "energy-other", name: "その他エネルギー施策", amount: 3038 },
      ],
    },
    {
      id: "sme",
    ...
    },
    {
      ...
      children: [
        ...
        { id: "other-gyosei", name: "一般行政費", amount: 32000 },
        { id: "other-justice", name: "司法・警察関係費", amount: 12000 },
        { id: "other-misc", name: "その他", amount: 11789 },
      ],
    },
  ],
};
  ...
  items: [
    {
      ...
      children: [
        ...
        },
        {
          ...
          amount: 39800,
          children: [
            { id: "social-care-service", name: "介護給付費", amount: 32800 },
            { id: "social-care-other", name: "その他介護関連", amount: 7000 },
          ],
        },
        {
          id: "social-child",
        ...
        { id: "social-other", name: "その他", amount: 1600 },
      ],
    },
    {
      id: "bond",
      ...
      amount: 255164,
      children: [
        { id: "bond-interest", name: "利子及割引料", amount: 87600 },
        { id: "bond-repay", name: "国債償還費", amount: 167564 },
      ],
    },
    {
      id: "localalloc",
    ...
    },
    {
      ...
      amount: 68219,
      children: [
        { id: "defense-jinken", name: "人件費・糧食費", amount: 22800 },
        { id: "defense-busshi", name: "装備品等購入費", amount: 19500 },
    ...
    },
    {
      ...
      children: [
        ...
        { id: "public-disaster", name: "災害復旧等", amount: 10800 },
        { id: "public-port", name: "港湾・空港・鉄道整備", amount: 2900 },
        { id: "public-forest", name: "林野公共事業", amount: 3600 },
        { id: "public-fishery", name: "漁港漁場整備", amount: 2000 },
        { id: "public-other", name: "その他公共事業", amount: 6928 },
      ],
    },
    {
      id: "education",
    ...
    },
    {
      ...
      amount: 13045,
      children: [
        { id: "food-kome", name: "農業経営安定対策", amount: 5500 },
        { id: "food-shokuhin", name: "食料品安定供給対策", amount: 4000 },
        { id: "food-other", name: "その他", amount: 3545 },
      ],
    },
    {
      id: "energy",
      ...
      amount: 8681,
      children: [
        { id: "energy-saisei", name: "再生可能エネルギー対策", amount: 3500 },
        { id: "energy-setsuyaku", name: "省エネルギー対策", amount: 2300 },
        { id: "energy-other", name: "その他エネルギー施策", amount: 2881 },
      ],
    },
    {
      id: "sme",
      ...
      amount: 1785,
      children: [
        { id: "sme-shien", name: "中小企業支援対策", amount: 1050 },
        { id: "sme-other", name: "その他", amount: 735 },
      ],
    },
    {
      id: "oda",
    ...
    },
    {
      ...
      amount: 124875,
      children: [
        { id: "other-reserve", name: "予備費", amount: 51000 },
        { id: "other-gyosei", name: "一般行政費", amount: 34000 },
        { id: "other-justice", name: "司法・警察関係費", amount: 11800 },
        { id: "other-misc", name: "その他", amount: 28075 },
      ],
    },
  ],
};
